const COOKIE_DETAILS = {
    ...
    "www.googletagmanager.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  },
  pid: {
    ".smartadserver.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://equativ.com/end-users-privacy-policy/"],
      },
    ],
  },
  XANDR_PANID: {
    ...
    ".adnxs.com": [
      {
        Category: "Functional",
        Purpose:
          "This cookie ensures browsers in an experiment group of the Chrome-facilitated testing period include the Sec-Cookie-Deprecation request header as soon as it becomes available.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  CookieConsent: {
    "cookiebot.com": [
      {
        Category: "Functional",
        Purpose: "Registers cookie preferences of a user",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.cookiebot.com/en/cookie-declaration/"],
      },
    ],
  },
  CookieConsentBulkTicket: {
    "cookiebot.com": [
      {
        Category: "Functional",
        Purpose: "Enables sharing cookie preferences across domains/websites",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.cookiebot.com/en/cookie-declaration/"],
      },
    ],
  ...
  userlang: {
    "cookiebot.com": [
      {
        Category: "Functional",
        Purpose: "Saves language preferences of the user for a website",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.cookiebot.com/en/cookie-declaration/"],
      },
    ],
  ...
  _gid: {
    "google-analytics.com": [
      {
        Category: "Analytics",
        Purpose: "ID used to identify users for 24 hours after last activity",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  __utma: {
    "google-analytics.com": [
      {
        Category: "Analytics",
        Purpose: "ID used to identify users and sessions",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
    ...
    "google.com": [
      {
        Category: "Functional",
        Purpose:
          "Google reCAPTCHA sets a necessary cookie (_GRECAPTCHA) when executed to provide its risk analysis.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  ADS_VISITOR_ID: {
    "google.com": [
      {
        Category: "Marketing",
        Purpose: "Cookie required to use the options and on-site web services",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  "1P_JAR": {
    ".google.com": [
      {
        Category: "Ad Performance & Frequency Capping",
        Purpose:
          "Used to collect website statistics and track conversion rates.",
        Impact:
          "Users will not be able to personalize their Google experiences, such as seeing personalized ads or recommendations.",
        Reference: ["https://business.safety.google/adscookies/"],
      },
    ],
  },
  CONSENT: {
    ".gstatic.com": [
      {
        Category: "Functional",
        Purpose: "Google cookie consent tracker",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  SOCS: {
    "google.com": [
      {
        Category: "Functional",
        Purpose: "Stores a user's state regarding their cookies choices",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  ACCOUNT_CHOOSER: {
    "accounts.google.com": [
      {
        Category: "Functional",
        Purpose: "Used to sign in with Google account.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  LSOLH: {
    "accounts.google.com": [
      {
        Category: "Functional",
        Purpose: "This cookie is for authentication with your Google account",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  g_enabled_idps: {
    "accounts.google.com": [
      {
        Category: "Functional",
        Purpose: "Used for Google Single Sign On",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  OTZ: {
    "google.com": [
      {
        Category: "Marketing",
        Purpose: "Aggregate analysis of website visitors",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
    ...
    "google.com": [
      {
        Category: "Marketing",
        Purpose:
          "Google uses this cookie to make advertising more engaging to users and more valuable to publishers and advertisers",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
    ...
    "google.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is used to collect website statistics and track conversion rates and Google ad personalization",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  NID: {
    ".google.com": [
      {
        Category: "Ad Personalization and Conversion Tracking",
        Purpose:
          "Used in the context of targeted advertising  by the entities defined by the domains of the cookies.",
        Impact:
          "Decrease tracking efficiency for ad targeting and therefore should impact conversions.",
        Reference: ["https://www.patrolbase.co.uk/cookie-preferences"],
      },
    ],
  },
  TAID: {
    "google.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is used to link your activity across devices if you’ve previously signed in to your Google Account on another device. We do this to coordinate the ads you see across devices and measure conversion events.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  IDE: {
    ".doubleclick.net": [
      {
        Category: "Ad Campaign Analysis and Optimization",
        Purpose:
          "This cookie is used by Google DoubleClick to register and report the website user's actions after viewing or clicking one of the advertiser's ads to measure the efficacy of an ad and to present targeted ads to the user.",
        Impact:
          "Blocking these cookies will impact the ability to measure ad engagement and conversion for media content will be severely limited. Websites relying on these cookies for user authentication and personalized content delivery will experience challenges.",
        Reference: ["https://www.patrolbase.co.uk/cookie-preferences"],
      },
    ],
  },
    ...
    "doubleclick.net": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is used for targeting, analyzing, and optimization of ad campaigns in DoubleClick/Google Marketing Suite ",
        Impact:
          "Hinders the effectiveness of personalized advertising and campaign performance measurement",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  },
  ...
  ar_debug: {
    "doubleclick.net": [
      {
        Category: "Marketing",
        Purpose: "Store and track ad conversions",
        Impact:
          "The ability to accurately measure ad campaign effectiveness and track conversions will be severely limited",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  },
  test_cookie: {
    ".doubleclick.net": [
      {
        Category: "Cookie Acceptance Verification",
        Purpose: "Used to check if the user's browser supports cookies.",
        Impact:
          "Blocking these cookies will impact the test results of browser support for cookies.",
        Reference: ["https://www.patrolbase.co.uk/cookie-preferences"],
      },
    ],
  },
    ...
    "doubleclick.net": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is used for targeting, analyzing, and optimizing ad campaigns in DoubleClick/Google Marketing Suite",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://privacy.google.com/take-control.html"],
      },
    ],
  ...
  S1: {
    "nl.sitestat.com": [
      {
        Category: "Analytics",
        Purpose: "Comscore: statistical and analytical data",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.comscore.com/About/Privacy-Policy"],
      },
    ],
  },
  C1: {
    ...
    ".207.net": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.adobe.com/nl/privacy.html"],
      },
    ],
  },
  demdex: {
    ".demdex.net": [
      {
        ...
        Purpose:
          "Audience Manager sets this cookie to assign a unique ID to a site visitor. The demdex cookie helps the Audience Manager perform basic functions, such as visitor identification, ID synchronization, segmentation, modeling, reporting, and so on.",
        Impact:
          "Blocking these cookies can impact the functionality and effectiveness of Adobe Audience Manager in terms of tracking and targeting users across various channels which may result in limitations in the ability to create and leverage audience segments, which are crucial for personalized and targeted digital marketing efforts.",
        Reference: [
          "https://experienceleague.adobe.com/docs/core-services/interface/administration/ec-cookies/cookies-am.html?lang=en",
        ],
      },
    ],
  },
    ...
    "demdex.net": [
      {
        Category: "Marketing",
        Purpose:
          "Used to determine if the browser of the user accepts cookies or not",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.adobe.com/nl/privacy.html"],
      },
    ],
    ...
    "adform.net": [
      {
        Category: "Marketing",
        Purpose:
          "Used to determine if the browser of the user accepts third-party cookies or not",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://site.adform.com/privacy-center/overview"],
      },
    ],
  },
  C: {
    ".adform.net": [
      {
        Category: "Cookie Acceptance Verification",
        Purpose: "Identifies if the user's browser accepts cookies.",
        Impact:
          "It will affect the storing of user preferences in components using AdForm",
        Reference: ["https://site.adform.com/privacy-center/adform-cookies/"],
      },
    ],
  },
  uid: {
    ".criteo.com": [
      {
        Category: "Ad Personalization and Conversion Tracking",
        Purpose:
          "Collects anonymous data related to the user's visits to the website, such as the number of visits, average time spent on the website, and what pages have been loaded, to display targeted ads.",
        Impact:
          "Decrease tracking efficiency for ad targeting and therefore should impact conversions.",
        Reference: ["https://ailab.criteo.com/cookie-declaration/"],
      },
    ],
    ".adform.net": [
      {
  ...
  GCM: {
    "adform.net": [
      {
        Category: "Marketing",
        Purpose: "Checks if a new partner cookie synchronization is required",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://site.adform.com/privacy-center/overview"],
      },
    ],
  ...
  token: {
    "adform.net": [
      {
        Category: "Marketing",
        Purpose: "Security token for opt-out functionality",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://site.adform.com/privacy-center/overview"],
      },
    ],
  ...
  otsid: {
    "adform.net": [
      {
        Category: "Marketing",
        Purpose: "Opt out a cookie for specific advertiser",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://site.adform.com/privacy-center/overview"],
      },
    ],
    ...
    "facebook.com": [
      {
        Category: "Marketing",
        Purpose:
          'Used to record whether the person chose to remain logged in Contents: User ID and miscellaneous login information (e.g., number of logins per account, state of the "remember me" check box, etc.)',
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.facebook.com/about/privacy/"],
      },
    ],
  },
  xs: {
  ...
  ick: {
    "facebook.com": [
      {
        Category: "Marketing",
        Purpose: "Stores an encryption key used to encrypt cookies",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.facebook.com/about/privacy/"],
      },
    ],
    ...
    "facebook.com": [
      {
        Category: "Marketing",
        Purpose:
          "Used to prevent the creation of fake/spammy accounts. Datr cookie is associated with a browser, not individual people.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.facebook.com/about/privacy/"],
      },
    ],
  ...
  fr: {
    ".facebook.com": [
      {
        Category: "Ad Personalization & Retargeting",
        Purpose: "Enables ad delivery or retargeting by tracking user",
        Impact:
          "Reduce the effectiveness of ad targeting based on user profiles and previous visits.",
        Reference: [
          "https://www.ey.com/en_gl/cookie-policy",
          "https://cookiedatabase.org/cookie/facebook/fr/",
          "https://wpstackable.com/cookie-policy/",
        ],
      },
    ],
  },
  ...
  js_ver: {
    "facebook.com": [
      {
        Category: "Marketing",
        Purpose: "Records the age of Facebook javascript files.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.facebook.com/about/privacy/"],
      },
    ],
  ...
  rc: {
    "facebook.com": [
      {
        Category: "Marketing",
        Purpose: "Used to optimize site performance for advertisers",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.facebook.com/about/privacy/"],
      },
    ],
    ...
    "facebook.com": [
      {
        Category: "Functional",
        Purpose:
          "This cookie stores the browser window dimensions and is used by Facebook to optimize the rendering of the page.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.facebook.com/about/privacy/"],
      },
    ],
    ...
    "creative-serving.com": [
      {
        Category: "Marketing",
        Purpose:
          "Used to check if Flash plugin is enabled in the browser of the user.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://platform161.com/cookie-and-privacy-policy/"],
      },
    ],
  },
  pvc2: {
    "creative-serving.com": [
      {
        Category: "Marketing",
        Purpose: "Contains information related to ad impressions.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://platform161.com/cookie-and-privacy-policy/"],
      },
    ],
  ...
  tuuid: {
    "creative-serving.com": [
      {
        Category: "Marketing",
        Purpose: "Unique value to identify individual users.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://platform161.com/cookie-and-privacy-policy/"],
      },
    ],
  ...
  MR: {
    "c.bing.com": [
      {
        Category: "Ad Campaign Measurement & Optimization",
        Purpose: "Indicates whether to refresh MUID.",
        Impact:
          "Blocking these cookies may disrupt the refreshing mechanism of the MUID, potentially impacting the accuracy of user tracking, targeted advertising, site analytics, and other operational functions on Microsoft sites.",
        Reference: [
    ...
    ".bat.bing.com": [
      {
        Category: "Ad Campaign Measurement & Optimization",
        Purpose:
          "Used for targeting, analysis, and optimization of advertising campaigns powered by the DoubleClick/Google Marketing Suite.",
        Impact:
          "Blocking these cookies may disrupt the refreshing mechanism of the MUID, potentially impacting the accuracy of user tracking, targeted advertising, site analytics, and other operational functions on Microsoft sites.",
        Reference: [
          "https://learn.microsoft.com/en-us/clarity/setup-and-installation/cookie-list",
  ...
  MUID: {
    ".clarity.ms": [
      {
        Category: "Cross-Device User Identification",
        Purpose:
          "Identifies unique web browsers visiting Microsoft sites. These cookies are used for advertising, site analytics, and other operational purposes.",
        Impact:
          "Prevent the identification of users across devices, and consequently impacting the accuracy of user tracking, targeted advertising, site analytics, and other operational functions on Microsoft sites.",
        Reference: ["https://syke.tech/cookie-policy/"],
      },
    ],
    ".bing.com": [
      {
    ...
    ".bing.com.microsoft.com": [
      {
        ...
        Purpose:
          "Identifies unique web browsers visiting Microsoft sites. These cookies are used for advertising, site analytics, and other operational purposes.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
  },
  MC1: {
  ...
  ANONCHK: {
    "c.clarity.ms": [
      {
        Category: "Ad Personalization",
        Purpose:
          "Used for passing user action information and reporting purposes to the Bing advertising network, and for personalization.",
        Impact:
          "Will lead to inaccurate click tracking, limited personalized content, and reduced reporting accuracy.",
        Reference: ["https://syke.tech/cookie-policy/"],
      },
    ],
  },
  CC: {
    "microsoft.com": [
      {
        Category: "Marketing",
        Purpose: "Contains a country code as determined from your IP address.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
  ...
  MC0: {
    "microsoft.com": [
      {
        Category: "Functional",
        Purpose: "Detects whether cookies are enabled in the browser.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
    ...
    "microsoft.com": [
      {
        Category: "Marketing",
        Purpose:
          "Contains information that Microsoft account uses within its pages about child accounts.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
  ...
  AADSSO: {
    "microsoft.com": [
      {
        Category: "Functional",
        Purpose: "Microsoft Microsoft Online Authentication Cookie",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
    ...
    "c.bing.com": [
      {
        ...
        Purpose:
          "Used for advertising, site analytics, and other operational purposes.",
        Impact:
          "Diminish browsing experience, including encountering more generic advertisements, and limited personalization.",
        Reference: ["https://syke.tech/cookie-policy/"],
      },
    ],
  },
  ...
  BCP: {
    "bing.com": [
      {
        Category: "Marketing",
        Purpose: "This cookie is used for advertisement tracking purposes.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
  ...
  stsservicecookie: {
    "microsoft.com": [
      {
        Category: "Functional",
        Purpose: "Cookie for Azure Active Directory B2C-verification",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://account.microsoft.com/privacy"],
      },
    ],
    ...
    ".c.clarity.ms": [
      {
        Category: "Cross-Device User Identification",
        Purpose:
          "Used to synchronize the ID across many different Microsoft domains to enable user tracking.",
        Impact:
          "Prevent the identification of users across devices, and consequently impact the effectiveness of user data analytics.",
        Reference: ["https://syke.tech/cookie-policy/"],
      },
    ],
    "c.clarity.ms": [
  ...
  CLID: {
    "www.clarity.ms": [
      {
        Category: "User Engagement and Analytics",
        Purpose:
          "Used for behavioral analytics that turns user data into visual insights and shows which parts of the website get the most engagement.",
        Impact:
          "Prevent site owners from gathering usage stats for visitors to their sites, such as number of visits, time spent on the site, targeted advertising interests, and so on.",
        Reference: ["https://syke.tech/cookie-policy/"],
      },
    ],
  },
    ...
    "twitter.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is set by X to identify and track the website visitor. Registers if a user is signed in the X platform and collects information about ad preferences. ",
        Impact: "Nothing was found in the cookie database.",
        Reference: [
    ...
    ".twitter.com": [
      {
        Category: "Ad Personalization",
        Purpose:
          "Used to identify the user devices on repeat visits across different sites that use the same ad network.",
        Impact:
          "Reduce the effectiveness of ad targeting based on user profiles and previous visits.",
        Reference: [],
      },
      {
        Category: "Social Media-Integrated Advertising",
        Purpose:
          "Sets a unique value by which Twitter identifies users. The collected information is used to personalize Twitter services, including ads, trends, and suggestions.",
        Impact:
          "Impacts Twitter by preventing it from gathering user information from the site the user is visiting.",
        Reference: ["https://help.twitter.com/en/rules-and-policies/x-cookies"],
      },
    ],
  },
  ct0: {
    "twitter.com": [
      {
        Category: "Marketing",
        Purpose:
          "These cookies enable us to track visitor activity from our X ads on our website, and also to allow users to share content from our websites. The cookies do not provide us with any confidential information relating to your account.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://twitter.com/en/privacy"],
      },
    ],
  },
  gt: {
    "twitter.com": [
      {
        Category: "Marketing",
        Purpose:
          "Twitter uses these cookies to support plugin integration with our website. If you use the Tweet plugin and log into your X account, X will set some of these cookies to remember that you are logged in. X will also use cookies for their analytics purposes.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://twitter.com/en/privacy"],
      },
    ],
  ...
  guest_id_marketing: {
    "twitter.com": [
      {
        Category: "Marketing",
        Purpose: "This cookie is for advertising when logged out",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://twitter.com/en/privacy"],
      },
    ],
    ...
    "t.co": [
      {
        Category: "Social Media-Integrated Advertising",
        Purpose:
          "Collects data on user behavior and interaction to optimize the website and make advertisements on the website more relevant.",
        Impact:
          "Prevent Twitter from gathering user information from the site the user is visiting.",
        Reference: ["https://help.twitter.com/en/rules-and-policies/x-cookies"],
      },
    ],
  },
    ...
    "twitter.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is set due to X integration and sharing capabilities for social media.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://twitter.com/en/privacy"],
      },
    ],
    ...
    ".twitter.com": [
      {
        Category: "Marketing",
        Purpose:
          "These are third-party X cookies. These cookies enable users, if they wish, to log in to their X account and share content from our websites with their friends. These cookies do not allow us access to your accounts or provide us with any confidential information relating to your accounts. These cookies also allow a news feed of tweets to appear on the website.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://twitter.com/en/privacy"],
      },
    ],
    ...
    ".twitter.com": [
      {
        Category: "Marketing",
        Purpose:
          "Used to collect information about users' browsing behavior for marketing purposes including digital display and social media advertising.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://twitter.com/en/privacy"],
      },
    ],
    ...
    "Inspectlet.com": [
      {
        Category: "Analytics",
        Purpose:
          "This cookie contains the page number of the session recording.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://docs.inspectlet.com/hc/en-us"],
      },
    ],
  },
  __insp_sid: {
  ...
  __insp_ref: {
    "Inspectlet.com": [
      {
        Category: "Analytics",
        Purpose: "The cookie contains the referrer source/URL",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://docs.inspectlet.com/hc/en-us"],
      },
    ],
    ...
    "Inspectlet.com": [
      {
        Category: "Analytics",
        Purpose:
          "This cookie contains a unique user ID provided by the website if set up.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://docs.inspectlet.com/hc/en-us"],
      },
    ],
  ...
  __insp_uid: {
    "Inspectlet.com": [
      {
        Category: "Analytics",
        Purpose: "This cookie contains a random ID assigned to a visitor.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://docs.inspectlet.com/hc/en-us"],
      },
    ],
    ...
    "Inspectlet.com": [
      {
        Category: "Analytics",
        Purpose:
          "Registers statistical data on visitors' behavior on the website. Used for internal analytics by the website operator.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://docs.inspectlet.com/hc/en-us"],
      },
    ],
    ...
    "conv.indeed.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.indeed.nl/legal"],
      },
    ],
  },
  ctkgen: {
    ...
    "admatic.com.tr": [
      {
        Category: "Marketing",
        Purpose:
          "Used to track visitors on multiple websites, to present relevant advertisement based on the visitor's preferences.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["http://www.admatic.com.tr/en/privacy-policy.html"],
      },
    ],
  },
  __adm_uiex: {
    ...
    ".adnxs.com": [
      {
        Category: "Ad Bidding",
        Purpose:
          "It contains base64-encoded values that enable Prebid Server demand partners to distinguish browsers and devices, facilitating the selection of advertisements for delivery and measuring their performance for attribution and payment on the platform.",
        Impact:
          "Disrupt the ability of Prebid Server demand partners to select and measure the performance of advertisements, affecting ad delivery and attribution on the platform running the prebid.org software.",
        Reference: [
    ...
    ".go.sonobi.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects information on visitor behavior on multiple websites. This information is used on the website, to optimize the relevance of advertisement.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://sonobi.com/privacy-policy/"],
      },
    ],
  },
  __uir_bw: {
    ...
    "contextweb.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: [
          "http://pulsepoints-new-website.webflow.io/privacy-policy/platform#consumer-choice",
        ],
      },
    ],
  },
    ...
    ".linkedin.com": [
      {
        ...
        Purpose: "This cookie is used to facilitate data center selection.",
        Impact:
          "Blocking these cookies will cause session disruption and performance issues.",
        Reference: ["https://www.linkedin.com/legal/l/cookie-table"],
      },
    ],
  },
  bcookie: {
    ".linkedin.com": [
      {
        Category: "Security",
        Purpose:
          "This cookie is used as a Browser Identifier cookie to uniquely identify devices accessing LinkedIn to detect abuse on the platform.",
        Impact:
          "Blocking this cookie will impact LinkedIn's ability to uniquely identify devices for abuse detection on the platform. LinkedIn uses this cookie to enhance security and identify potentially malicious or abusive activities.",
        Reference: ["https://www.linkedin.com/legal/l/cookie-table"],
      },
    ],
  },
    ...
    ".www.linkedin.com": [
      {
        ...
        Impact:
          "This cookie likely helps streamline the login process for users who have already undergone 2FA. Blocking it might require users to go through 2FA more frequently or experience inconvenience during the login process.",
        Reference: ["https://www.linkedin.com/legal/l/cookie-table"],
      },
    ],
  },
    ...
    "linkedin.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.linkedin.com/legal/privacy-policy"],
      },
    ],
  },
  trkInfo: {
  ...
  li_oatml: {
    "linkedin.com": [
      {
        Category: "Marketing",
        Purpose: "Collects information about how visitors use our site.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.linkedin.com/legal/privacy-policy"],
      },
    ],
    ...
    ".linkedin.com": [
      {
        ...
        Purpose:
          "Used for id sync process. It stores the last sync time to avoid frequently repeating the syncing process",
        Impact:
          "Blocking these cookies will hinder user analytics, and personalized advertising, and limit LinkedIn's ability to optimize the user experience based on individual behavior.",
        Reference: ["https://www.linkedin.com/legal/l/cookie-table"],
      },
    ],
  },
  lang: {
    "linkedin.com": [
      {
        Category: "Functional",
        Purpose: "Used to remember a user's language setting",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.linkedin.com/legal/privacy-policy"],
      },
    ],
    ".paypal.com": [
      {
        Category: "Functional",
        Purpose: "This cookie stores the selected locale",
        Impact:
          "Prevents PayPal from remembering the user's selected language or region preference",
        Reference: ["https://www.paypal.com/privacy-center"],
      },
    ],
  },
  li_gc: {
    ...
    ".linkedin.com": [
      {
        ...
        Impact:
          "Blocking these cookies may limit analytics data collection, impacting the platform's understanding of user engagement and potentially hindering the effectiveness of ad targeting, and a potentially less personalized user experience.",
        Reference: ["https://www.linkedin.com/legal/l/cookie-table"],
      },
    ],
  },
    ...
    "amazon-adsystem.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://amazon.com/privacy/"],
      },
    ],
  },
  "ad-privacy": {
  ...
  CMID: {
    "casalemedia.com": [
      {
        Category: "Targeted Advertisement",
        Purpose:
          "Collects anonymous data related to the user's visits to the website, such as the number of visits, average time spent on the website, and what pages have been loaded, to display targeted ads.",
        Impact:
          "Prevent site owners from gathering usage stat for visitors to their sites, such as number of visits, time spent on the site, targeted advertising interests, and so on",
        Reference: ["https://sugru.com/cookies"],
      },
    ],
  },
  CMPRO: {
    "casalemedia.com": [
      {
        Category: "Ad Performance & Frequency Capping",
        Purpose:
          "Used for measuring the performance of ads across multiple sites and also controlling the showing of repeated ads to users",
        Impact:
          "Ad performance will not work and users may experience the repeated appearance of ads",
        Reference: [],
      },
    ],
  },
    ...
    "casalemedia.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects visitor data related to the user's visits to the website, such as the number of visits, average time spent on the website, and what pages have been loaded, to display targeted ads.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://casalemedia.com"],
      },
    ],
  },
  CMST: {
    ...
    "outbrain.com": [
      {
        ...
        Purpose: "Pending",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.outbrain.com/legal/privacy#privacy-policy"],
      },
    ],
  },
  obuid: {
    ...
    "outbrain.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is set by Outbrain and it is used to analyze technical data about the website",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.outbrain.com/legal/privacy#privacy-policy"],
      },
    ],
    ...
    "justpremium.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://justpremium.com/terms-conditions/"],
      },
    ],
  },
  jpxumatched: {
    ...
    "pubmatic.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
  },
  pp: {
    ...
    ".pubmatic.com": [
      {
        ...
        Impact:
          "Ad performance will not work and users may experience the repeated appearance of ads",
        Reference: ["https://pubmatic.com/legal/platform-cookie-policy/"],
      },
    ],
  },
  PUBRETARGET: {
    ...
    "pubmatic.com": [
      {
        Category: "Marketing",
        Purpose:
          "To avoid race condition in PubMatic userId generation, showad.js / universalpixel.js set this cookie first. if and only if not set already. The existence of this cookie means that the current flow of the execution should not generate a PubMatic userId cookie, as it is already being set by another flow that has set KCCH.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Marketing",
        Purpose:
          "Keeps list of DSP pixel Id's PubMatic synced with so far. PubMatic does userId sync up with DSP's. This cookie holds the next sync-up time for every pixel. Helps to maintain sync-up frequency at DSP level.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Marketing",
        Purpose:
          "Keeps the list of DMP pixel Id's PubMatic synced with so far PubMatic does userId sync up with DMP's. This cookie holds the next sync-up time for every pixel. Helps to maintain sync up frequency at DMP level.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Marketing",
        Purpose:
          "PubMatic UserId. this identifier to identify each user uniquely. Some of the uses of this anonymous identifier are to support frequency capping and perform UID sync-ups with DSP's, DMP's. DMP's / DP's push audience data against this ID. API publishers send this ID while making API requests to PubMatic AdServer. UAS Ad Engine also uses this cookie for FCAP purposes.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Marketing",
        Purpose:
          "It is used to track when the cookies were updated on the browser. It is used to limit the number of calls to the server-side cookie store",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Functional",
        Purpose:
          "This cookie stores the period after which ad frequency counters reset.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie stores information regarding the number of times that a partner’s pixel is loaded by a user’s browser. This enables us to cap the number of times that a pixel is used to record a user’s visit to a website within a specific time.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
  ...
  _curtime: {
    "pubmatic.com": [
      {
        Category: "Functional",
        Purpose: "This cookie stores the current timestamp.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Functional",
        Purpose:
          "This cookie is set for the Komli ad server and is used for default impression when other data is not available.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
    ...
    "pubmatic.com": [
      {
        Category: "Functional",
        Purpose:
          "This cookie is set on Google Chrome browsers that have a version less than 67 or non-Chrome browsers, and is used for testing purposes.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://pubmatic.com/legal/privacy/"],
      },
    ],
  ...
  pubsyncexp: {
    ".pubmatic.com": [
      ...
      {
        Category: "Real-Time Bidding & Advertiser Matching",
        Purpose:
          "Sets a unique ID for the visitor. Third-party advertisers use it to target them with relevant ads. Third-party advertisement hubs provide this pairing service, facilitating real-time bidding for advertisers.",
        Impact:
          "Add complications with real-time ad bidding system and advertiser-to-user matching",
        Reference: [],
      },
    ],
  },
    ...
    "kiyoh.nl": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.kiyoh.nl/disclaimer.html"],
      },
    ],
  },
  id5: {
    "id5-sync.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.id5.io/privacy-policy"],
      },
    ],
  },
  cip: {
    ...
    "id5-sync.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects data on visitor behavior from multiple websites, to present more relevant advertisement - This also allows the website to limit the number of times that the visitor is shown the same advertisement.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.id5.io/privacy-policy"],
      },
    ],
    ...
    "scorecardresearch.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects information of the user and his/her movement, such as timestamp for visits, most recently loaded pages, and IP address. The data is used by the marketing research network, Scorecard Research, to analyze traffic patterns and carry out surveys to help their clients better understand the customer's preferences.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.comscore.com/About/Privacy-Policy"],
      },
    ],
    ...
    "semasio.net": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["http://www.semasio.net"],
      },
    ],
  },
  rek_content: {
  ...
  um: {
    "ad.360yield.com": [
      {
        Category: "Marketing",
        Purpose: "To enable the bidding process.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.improvedigital.com/platform-privacy-policy/"],
      },
    ],
  },
  umeh: {
    ...
    "vmg.host": [
      {
        Category: "Marketing",
        Purpose:
          "Collects data on visitor behaviour from multiple websites, to present more relevant advertisement - This also allows the website to limit the number of times that the visitor is shown the same advertisement.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "atdmt.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects information on visitor behaviour on multiple websites. This information is used on the website, to optimize the relevance of advertisement.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "teads.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.teads.com/privacy-policy/"],
      },
    ],
  },
  gckp: {
    "cxense.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.cxense.com/about-us/platform-privacy-policy"],
      },
    ],
  },
  um2: {
  ...
  cct: {
    "adscale.de": [
      {
        Category: "Marketing",
        Purpose: "Necessary for the shopping cart functionality on the website",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
  ...
  st_csd: {
    "seedtag.com": [
      {
        Category: "Marketing",
        Purpose: "Date of the last cookie-syn",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
  ...
  st_cs: {
    "seedtag.com": [
      {
        Category: "Marketing",
        Purpose: "Unique identifiers of DSPs",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
  ...
  dyncdn: {
    "smartadserver.com": [
      {
        Category: "Functional",
        Purpose: "End-point and traffic data",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://equativ.com/end-users-privacy-policy/"],
      },
    ],
  ...
  gid: {
    "smartadserver.com": [
      {
        Category: "Marketing",
        Purpose: "Global unique ID cross domains associated with an end-user",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://equativ.com/end-users-privacy-policy/"],
      },
    ],
  ...
  "partner-": {
    "smartadserver.com": [
      {
        Category: "Marketing",
        Purpose: "Labeling end-users with keywords defined by a client.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://equativ.com/end-users-privacy-policy/"],
      },
    ],
  ...
  sasd: {
    "smartadserver.com": [
      {
        Category: "Marketing",
        Purpose: "Geolocation collection",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://equativ.com/end-users-privacy-policy/"],
      },
    ],
  ...
  csync: {
    ".smartadserver.com": [
      {
        Category: "Ad Network Synchronization",
        Purpose:
          "Used for ad network synchronization by centralizing data and operations. Optimises ad display based on the user's movement combined and various advertiser bids for displaying user ads.",
        Impact: "Diminish the scope of advertising campaigns",
        Reference: ["https://www.act.edu/cookie-policy"],
      },
    ],
  },
  TestIfCookieP: {
    ...
    "liadm.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects data on visitors' behavior and interaction - This is used to make advertisements on the website more relevant. The cookie also allows the website to detect any referrals from other websites.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "taboola.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie gives a user who interacts with Taboola Widget a User ID allowing us to target advertisements and content to this specific user ID.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "openx.net": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.openx.com/privacy-center/privacy-policy/"],
      },
    ],
  },
  __atuvc: {
    ".addthis.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.addthis.com/privacy"],
      },
    ],
  },
  __atuvs: {
    ...
    ".dlx.addthis.com": [
      {
        Category: "Functional",
        Purpose:
          "Used by the social sharing platform AddThis to keep a record of parts of the site that have been visited to recommend other parts of the site.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.addthis.com/privacy"],
      },
    ],
    ...
    "funda.nl": [
      {
        ...
        Purpose: "Pending",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.funda.nl/privacybeleid/consument/"],
      },
    ],
  },
  DG_IID: {
  ...
  __auc: {
    ".trustpilot.com": [
      {
        Category: "Analytics",
        Purpose: "Used to track and report information to the Alexa analytics",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    ".trustpilot.com": [
      {
        Category: "Analytics",
        Purpose:
          " This cookie helps track visitor usage, events, and target marketing, and can also measure application performance and stability.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
  ...
  ajs_group_id: {
    ".trustpilot.com": [
      {
        Category: "Analytics",
        Purpose: "Track visitor usage and events within the website",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
  ...
  __asc: {
    ".trustpilot.com": [
      {
        Category: "Analytics",
        Purpose: "A cookie set by Trustpilot if you click the read more widget",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "sharethis.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://sharethis.com/privacy/"],
      },
    ],
  },
  __uin_mm: {
    ...
    "crwdcntrl.net": [
      {
        Category: "Marketing",
        Purpose:
          "Collects anonymous statistical data related to the user's website visits, such as the number of visits, average time spent on the website, and what pages have been loaded. The purpose is to segment the website's users according to factors such as demographics and geographical location, to enable media and marketing agencies to structure and understand their target groups to enable customized online advertising.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [
    ...
    "agkn.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.home.neustar/privacy"],
      },
    ],
  },
  bkdc: {
    "bluekai.com": [
      {
        Category: "Marketing",
        Purpose:
          "Registers anonymized user data, such as IP address, geographical location, visited websites, and what ads the user has clicked, to optimize ad display based on the user's movement on websites that use the same ad network.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [
    ...
    "mathtag.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.mediamath.com/privacy-policy/"],
      },
    ],
  },
  mt_mop: {
    ...
    "powerlinks.com": [
      {
        ...
        Purpose:
          "This cookie registers data on the visitor. The information is used to optimize advertisement relevance.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.powerlinks.com/privacy-policy/"],
      },
    ],
  },
  pxrc: {
    "rlcdn.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.towerdata.com/privacy-policy"],
      },
    ],
  },
  rlas3: {
    ...
    "tapad.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.tapad.com/privacy"],
      },
    ],
  },
  TapAd_TS: {
    ...
    ".adsrvr.org": [
      {
        ...
        Purpose:
          "The TDCPM cookie is used to register a unique ID that identifies a returning user's device. The ID is used for targeted ads.",
        Impact:
          "Ad performance will not work and users may experience the repeated appearance of ads",
        Reference: [
          "https://oxfambelgie.be/sites/default/files/2022-06/targeting_cookies_obe.pdf",
        ],
      },
    ],
  },
    ...
    "stickyadstv.com": [
      {
        Category: "Marketing",
        Purpose:
          "The uid cookie is used by FreeWheel to generate statistics to show how many people may have seen a particular ad. Whereas the other cookies recognize returning users to present users with relevant advertisements.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.freewheel.com/privacy-policy"],
      },
    ],
  },
  MRM_UID: {
    "stickyadstv.com": [
      {
        Category: "Marketing",
        Purpose:
          "Used to track the visitor across multiple devices including TV",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.freewheel.com/privacy-policy"],
      },
    ],
    ...
    "zeotap.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.zeotap.com/privacy_policy"],
      },
    ],
  },
  amplitude_id: {
    ...
    "admixer.net": [
      {
        ...
        Purpose:
          "This cookie is used to identify the visitor and optimize ad-relevance by collecting visitor data from multiple websites - this exchange of visitor data is normally provided by a third-party data center or ad exchange.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://admixer.net/privacy"],
      },
    ],
  },
  _cc_dc: {
    ...
    "lijit.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.sovrn.com/legal/privacy-policy/"],
      },
    ],
  },
  ljtrtb: {
    "lijit.com": [
      {
        Category: "Marketing",
        Purpose:
          "Enables us to help our advertising partners make decisions about advertising for you. We store the ID that each partner uses to identify you and pass that information to the partner when a website requests an advertisement from us.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.sovrn.com/legal/privacy-policy/"],
      },
    ],
    ...
    "pinterest.com": [
      {
        Category: "Functional",
        Purpose:
          "Pinterest cookie ensures that you can share our website pages via Pinterest using the 'share' button",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://policy.pinterest.com/en/privacy-policy"],
      },
    ],
  },
  _pinterest_sess: {
    "pinterest.com": [
      {
        Category: "Functional",
        Purpose:
          "session cookie (expires after your session) which collects anonymous data about a user's visit to the website, such as the number of visits, average time spent on the site, and which pages have been loaded to personalize and improve the Pinterest service.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://policy.pinterest.com/en/privacy-policy"],
      },
    ],
    ...
    "pinterest.com": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is a third-party cookie which groups actions for users who cannot be identified by Pinterest.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://policy.pinterest.com/en/privacy-policy"],
      },
    ],
  ...
  "dsps:": {
    "px.powerlinks.com": [
      {
        Category: "Marketing",
        Purpose: "Service to display targeted advertising to visitors.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.powerlinks.com/privacy-policy/"],
      },
    ],
    ...
    "vuble.tv": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.vuble.tv/privacy"],
      },
    ],
  },
  koitk: {
    ".marketingautomation.services": [
      {
        ...
        Purpose:
          "Collects data on visitors' behavior and interaction - This is used to optimize the website and make advertisement on the website more relevant.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.constantcontact.com/legal/privacy-notice"],
      },
    ],
  },
  app_ts: {
    "adscience.nl": [
      {
        Category: "Marketing",
        Purpose: "Used by adscience.nl to display remarketing campaigns.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.ortecadscience.com/privacy-policy/"],
      },
    ],
  },
  viewer: {
  ...
  euconsent: {
    "faktor.io": [
      {
        Category: "Marketing",
        Purpose: "Cookie compliance check",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://liveramp.com/privacy/"],
      },
    ],
  },
  "SSR-caching": {
    "wix.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: [
          "https://support.wix.com/erticle/cookies-and-your-wix-site",
        ],
      },
    ],
  },
    ...
    "shopify.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.shopify.com/legal/cookies"],
      },
    ],
  },
  _secure_session_id: {
  ...
  tracked_start_checkout: {
    "shopify.com": [
      {
        Category: "Analytics",
        Purpose: "Shopify analytics relating to checkout.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.shopify.com/legal/cookies"],
      },
    ],
  ...
  _Brochure_session: {
    "shopify.com": [
      {
        Category: "Analytics",
        Purpose: "Used in connection with browsing through the site.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.shopify.com/legal/cookies"],
      },
    ],
    ...
    "hubspot.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.hubspot.com/privacy-policy"],
      },
    ],
  },
  __hs_do_not_track: {
    ...
    "vimeo.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://vimeo.com/cookie_policy"],
      },
    ],
  },
  Player: {
    ...
    "stripe.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://stripe.com/en-nl/privacy"],
      },
    ],
  },
  __stripe_sid: {
  ...
  m: {
    "m.stripe.com": [
      {
        Category: "Functional",
        Purpose: "Set by payment provider stripe.com to process payments",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://stripe.com/en-nl/privacy"],
      },
    ],
    ...
    "snapwidget.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://snapwidget.com/privacy"],
      },
    ],
  },
    ...
    "woocommerce.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://automattic.com/privacy/"],
      },
    ],
  },
  ...
  edgebucket: {
    "reddit.com": [
      {
        Category: "Marketing",
        Purpose: "Used by Reddit to deliver advertising",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.redditinc.com/policies/privacy-policy"],
      },
    ],
  },
  initref: {
    ...
    "spotify.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.spotify.com/us/privacy/"],
      },
    ],
  },
  sp_landing: {
    ...
    ".adnxs.com": [
      {
        Category: "User Engagement and Analytics",
        Purpose:
          "Used to track user behavior and interactions as they navigate sites",
        Impact:
          "Prevent site owners from gathering usage stat for visitors to their sites, such as number of visits, time spent on the site, targeted advertising interests, and so on",
        Reference: [
          "https://about.ads.microsoft.com/en-us/solutions/xandr/digital-platform-cookie-policy",
    ...
    "adnxs.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.xandr.com/privacy/platform-privacy-policy/"],
      },
    ],
  },
  sc_at: {
    "snapchat.com": [
      {
        Category: "Marketing",
        Purpose: "Used to identify a visitor across multiple domains.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.snap.com/en-US/privacy/privacy-policy/"],
      },
    ],
  },
  "sc-a-nonce": {
    "snapchat.com": [
      {
        Category: "Marketing",
        Purpose: "Nonce control. Used to encrypt session data.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.snap.com/en-US/privacy/privacy-policy/"],
      },
    ],
    ...
    "dev.visualwebsiteoptimizer.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://vwo.com/privacy-policy/"],
      },
    ],
  },
  uesign: {
    "salesiq.zoho.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.zoho.com/privacy.html"],
      },
    ],
  },
  wa_ul: {
    "whatsapp.com": [
      {
        Category: "Functional",
        Purpose: "Used to access the service it provides.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.whatsapp.com/privacy/"],
      },
    ],
  },
  wa_lang_pref: {
    "whatsapp.com": [
      {
        Category: "Functional",
        Purpose: "Used by WhatsApp to save language preferences",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.whatsapp.com/privacy/"],
      },
    ],
    ...
    "prfct.co": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.perfectaudience.com/privacy/"],
      },
    ],
  },
  pa_google_ts: {
    ...
    "prf.hn": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://partnerize.com/privacy-policy/"],
      },
    ],
  },
  digitalAudience: {
    "digitalaudience.io": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://digitalaudience.io/legal/"],
      },
    ],
  },
  audience: {
    "spotxchange.com": [
      {
        Category: "Marketing",
        Purpose: "Sync audience data between buyers and sellers.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.spotx.tv/privacy-policy/"],
      },
    ],
  },
  A3: {
    "yahoo.com": [
      {
        Category: "Marketing",
        Purpose: "Ads targeting cookie for Yahoo",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://yahoo.com/privacy/"],
      },
    ],
  },
  APID: {
    ...
    "quantserve.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.quantcast.com/privacy/"],
      },
    ],
  },
  mc: {
    "quantserve.com": [
      {
        Category: "Marketing",
        Purpose:
          "Tracking of users and measure and improve performance and supports personalization",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.quantcast.com/privacy/"],
      },
    ],
    ...
    "issuu.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://issuu.com/legal/privacy"],
      },
    ],
  },
  __lc_cid: {
    "livechatinc.com": [
      {
        ...
        Purpose:
          "Necessary for the functionality of the website's chat-box function.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.livechat.com/legal/privacy-policy/"],
      },
    ],
  },
  __lc_cst: {
  ...
  __livechat: {
    "livechatinc.com": [
      {
        Category: "Functional",
        Purpose: "Used to hide the user's customization of LiveChat.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.livechat.com/legal/privacy-policy/"],
      },
    ],
    ...
    "network.bazaarvoice.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.bazaarvoice.com/legal/privacy-policy/"],
      },
    ],
  },
  BVBRANDSID: {
    ...
    "va.tawk.to": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.tawk.to/privacy-policy/"],
      },
    ],
  },
  stx_user_id: {
    "sharethrough.com": [
      {
        Category: "Marketing",
        Purpose: "Delivering targeted and relevant content",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://platform-cdn.sharethrough.com/privacy-policy"],
      },
    ],
  },
  dc: {
    "betweendigital.com": [
      {
        Category: "Marketing",
        Purpose: "This cookie is used for advertising purposes",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "blueconic.net": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.blueconic.com/privacy-policy/"],
      },
    ],
  },
  BCReferrerOverrule: {
    ...
    "weborama.fr": [
      {
        Category: "Analytics",
        Purpose:
          "Used by the advertising platform Weborama to determine the visitor’s interests based on page visits, content clicked, and other actions on the website.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://weborama.com/en/weborama-privacy-commitment/"],
      },
    ],
  },
  matchadform: {
    "w55c.net": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.roku.com/legal"],
      },
    ],
  },
  wfivefivec: {
    ...
    "adfarm3.adition.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.adition.com/kontakt/datenschutz/"],
      },
    ],
  },
  arcki2: {
    "audrte.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects data on user behavior and interaction to optimize the website and make advertisement on the website more relevant.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
    ...
    "stonly.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://stonly.com/privacy"],
      },
    ],
  },
  MONITOR_WEB_ID: {
    "mon-va.byteoversea.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: [
          "https://www.tiktok.com/legal/page/eea/privacy-policy/en?lang=en",
        ],
      },
    ],
  },
    ...
    "tiktok.com": [
      {
        Category: "Marketing",
        Purpose:
          "Collects information on user behavior on multiple websites. This information is used to optimize the relevance of advertisement on the website.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [
          "https://www.tiktok.com/legal/page/eea/privacy-policy/en?lang=en",
        ],
  ...
  HAPLB8: {
    "go.sonobi.com": [
      {
        Category: "Marketing",
        Purpose: "Sonobi sets this cookie for advertising purposes.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://sonobi.com/privacy-policy/"],
      },
    ],
    ...
    ".paypal.com": [
      {
        ...
        Impact: "Might disrupt the PayPal payment service on the website",
        Reference: ["https://www.paypal.com/privacy-center"],
      },
    ],
  },
    ...
    ".paypal.com": [
      {
        ...
        Impact:
          "Might disrupt or prevent transactions from being completed on the website",
        Reference: ["https://www.paypal.com/privacy-center"],
      },
    ],
  },
    ...
    "www.paypal.com": [
      {
        ...
        Impact: "Increases the risk of fraudulent activity on the website",
        Reference: ["https://www.paypal.com/privacy-center"],
      },
    ],
  },
    ...
    "paypal.com": [
      {
        Category: "Functional",
        Purpose:
          "Paypal - These cookies are essential to enable you to move around the website and use its features, such as accessing secure areas of the website. Without these cookies services you have asked for, like shopping baskets or e-billing, cannot be provided.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.paypal.com/privacy-center"],
      },
    ],
    ...
    ".paypal.com": [
      {
        ...
        Impact:
          "Prevents users from logging in to their PayPal accounts on the website",
        Reference: ["https://www.paypal.com/privacy-center"],
      },
    ],
  },
    ...
    "e-volution.ai": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://e-volution.ai/privacy/"],
      },
    ],
  },
  "idsync-bsw-uid-s": {
    ...
    "onaudience.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.onaudience.com/privacy-policy"],
      },
    ],
  },
  "vidoomy-uids": {
    "vidoomy.com": [
      {
        Category: "Marketing",
        Purpose:
          "Used in context with video advertisement. The cookie limits the number of times a user is shown the same advertisement. The cookie is also used to ensure the relevance of the video-advertisement to the specific user.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.vidoomy.com/privacypolicy-en.html"],
      },
    ],
  },
  viewer_token: {
    "csync.loopme.me": [
      {
        Category: "Marketing",
        Purpose:
          "This cookie is associated with csync.loopme.me. It is used to track visitors on multiple websites to present relevant advertising based on the visitor's preferences.",
        Impact: "Nothing was found in the cookie database.",
        Reference: [],
      },
    ],
  ...
  _stidv: {
    "sharethis.com": [
      {
        Category: "Marketing",
        Purpose: "ShareThis cookie ID version.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://sharethis.com/privacy/"],
      },
    ],
    ...
    "sharethis.com": [
      {
        Category: "Analytics",
        Purpose:
          "ShareThis Tag Management System cookie to track the status of pixel rotation loading. ShareThis uses a different cookie for different groups of sites within the ShareThis network.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://sharethis.com/privacy/"],
      },
    ],
    ...
    "rubiconproject.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.magnite.com/legal/platform-cookie-statement/"],
      },
    ],
  },
  audit: {
    "rubiconproject.com": [
      {
        Category: "Marketing",
        Purpose: "Set by Rubicon Project to record cookie consent data.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.magnite.com/legal/platform-cookie-statement/"],
      },
    ],
    ...
    "rubiconproject.com": [
      {
        Category: "Marketing",
        Purpose:
          "Records anonymous user data, such as IP, geographical location, websites visited and ads clicked on, to optimize visualization of ads according to user movement around websites using the same advertising network.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.magnite.com/legal/platform-cookie-statement/"],
      },
    ],
    ...
    "gigya.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.sap.com/privacy"],
      },
    ],
  },
  gig_bootstrap_: {
    "gigya.com": [
      {
        Category: "Marketing",
        Purpose: "If declined, the user may be intermittently logged out.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.sap.com/privacy"],
      },
    ],
  ...
  gig_hasGmid: {
    "gigya.com": [
      {
        Category: "Marketing",
        Purpose: "Internal cookie for the Web SDK",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.sap.com/privacy"],
      },
    ],
  ...
  _gig_llu: {
    "gigya.com": [
      {
        Category: "Marketing",
        Purpose: "Last login provider username for Login Welcome back screen.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.sap.com/privacy"],
      },
    ],
    ...
    "the-ozone-project.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.ozoneproject.com/privacy-matters"],
      },
    ],
  },
    ...
    "hotjar.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.getbeamer.com/privacy-policy"],
      },
    ],
  },
  _BEAMER_USER_ID_: {
  ...
  adhese2: {
    "ads-[account].adhese.com": [
      {
        Category: "Analytics",
        Purpose: "Unique Reach reporting",
        Impact: "Nothing was found in the cookie database.",
        Reference: [
          "https://adhese.com/images/Privacy%20Policy_Doggybites.pdf",
        ],
      },
    ],
  },
    ...
    ".adhese.com": [
      {
        Category: "Marketing",
        Purpose:
          "When Adhese is used as a server connection to SSPs or DSPs with whom the Account holder has a contract, a user syncing process can be installed where the SSP user_uid is stored in an Adhese cookie. This is dependent on consent for all parties involved (Accountholder, SSP, Adhese)",
        Impact: "Nothing was found in the cookie database.",
        Reference: [
          "https://adhese.com/images/Privacy%20Policy_Doggybites.pdf",
        ],
    ...
    "kelkoogroup.net": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.kelkoogroup.com/privacy-policy/"],
      },
    ],
  },
  TXCSDMN_: {
    "tappx.com": [
      {
        Category: "Marketing",
        Purpose: "This cookie is associated with Tappx, an AdTech platform.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.tappx.com/legal/privacy-policy"],
      },
    ],
  },
  TXCD: {
    ...
    "richaudience.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://richaudience.com/en/privacy/"],
      },
    ],
  },
  "avcid-": {
  ...
  pdid: {
    "richaudience.com": [
      {
        Category: "Marketing",
        Purpose: "Randomly generated user ID.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://richaudience.com/en/privacy/"],
      },
    ],
    ...
    "contextual.media.net": [
      {
        Category: "Marketing",
        Purpose:
          "Cookie used to record your browsing activity, to display targeted ads.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.media.net/privacy-policy/"],
      },
    ],
  },
  "visitor-id": {
    ...
    "dotomi.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
  },
  cjae: {
    "dotomi.com": [
      {
        Category: "Marketing",
        Purpose:
          "The cookie is set by the provider Dotomi. This cookie is used to record visitor behavior.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
  ...
  DotomiStatus: {
    "dotomi.com": [
      {
        Category: "Marketing",
        Purpose: "Used to honor device-level opt-out preferences.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
  ...
  DotomiSession_: {
    "dotomi.com": [
      {
        Category: "Marketing",
        Purpose: "Pseudonymous session-id",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
    ...
    "dotomi.com": [
      {
        Category: "Marketing",
        Purpose:
          "Set when GDPR data delete is executed. The life span is 30 days. When this cookie exists, GDPR consent is considered revoked.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
    ...
    "dotomi.com": [
      {
        Category: "Marketing",
        Purpose:
          "Set when GPC Optout is initiated. The presence of this cookie helps us prevent multiple downstream opt-out requests for the same user",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
  ...
  pluto: {
    "fastclick.net": [
      {
        Category: "Marketing",
        Purpose: "The Session ID is used to track preference information.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
  ...
  svid: {
    "mediaplex.com": [
      {
        Category: "Marketing",
        Purpose: "Used to relate preference information for marketing purposes",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
    ...
    "mediaplex.com": [
      {
        Category: "Marketing",
        Purpose:
          "Used to track last time the browser was redirected through Corporate Cookie Service / Dotomi.com domain",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://legal.epsilon.com/global-privacy-policies/"],
      },
    ],
    ...
    ".yandex.ru": [
      {
        ...
        Purpose: "Session ID",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://yandex.com/support/metrica/general/gdpr.html"],
      },
    ],
  },
  _ym_debug: {
    ...
    "salesforce.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/legal/"],
      },
    ],
  },
  pctrk: {
    ...
    "salesforce.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  },
  QCQQ: {
  ...
  sid_Client: {
    "salesforce.com": [
      {
        Category: "Functional",
        Purpose: "Used to validate orgid and userid on the client side.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  ...
  idccsrf: {
    "salesforce.com": [
      {
        Category: "Functional",
        Purpose: "Used for SSO authentication as CSRF protection.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  ...
  rsid: {
    "salesforce.com": [
      {
        Category: "Functional",
        Purpose: "Used for an admin user to 'log in as' one of their org user.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  ...
  RRetURL: {
    "salesforce.com": [
      {
        Category: "Functional",
        Purpose: "Used for 'log in as' to return to the original page.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  ...
  RRetURL2: {
    "salesforce.com": [
      {
        Category: "Functional",
        Purpose: "Used for portal 'log in as' to return to the original page.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  ...
  clientSrc: {
    "salesforce.com": [
      {
        Category: "Functional",
        Purpose: "Used to validate the IP from where a user logs in.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
  ...
  expid_: {
    "salesforce.com": [
      {
        Category: "Marketing",
        Purpose: "Used to render pages based on specified brand.",
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.salesforce.com/company/privacy/"],
      },
    ],
    ...
    "imrworldwide.com": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.nielsen.com/legal/privacy-principles/"],
      },
    ],
  },
  i00: {
    "ioam.de": [
      {
        ...
        Impact: "Nothing was found in the cookie database.",
        Reference: ["https://www.infonline.de/en/datenschutzerklaerung/"],
      },
    ],
  },
  DPSync3: {
    ".pubmatic.com": [
      {
        Category: "Ad Network Synchronization",
        Purpose:
          "Used for ad network synchronization by centralizing data and operations",
        Impact: "Diminish the scope of advertising campaigns",
        Reference: ["https://pubmatic.com/legal/platform-cookie-policy/"],
      },
    ],
    ...
    ".izooto.com": [
      {
        ...
        Purpose:
          "This cookie is used for the iZooto push notification feature.",
        Impact:
          "Blocking these cookies prevents iZooto from sending push notifications.",
        Reference: [],
      },
    ],
  },
  KRTBCOOKIE_XXX: {
    ".pubmatic.com": [
      ...
      },
      {
        Category: "Cross-Device User Identification",
        Purpose:
          "To track user activity and show targeted ads. They contain a unique ID that identifies the user's device and helps recognize returning users for a personalized browsing experience across different devices.",
        Impact:
          "Prevent the identification of users across devices, and consequently impact the effectiveness of cross-device advertising campaigns.",
        Reference: [],
      },
    ],
  },
    ...
    ".dpm.demdex.net": [
      {
        ...
        Impact:
          "Blocking these cookies can impact the functionality and effectiveness of Adobe Audience Manager in terms of tracking and targeting users across various channels which may result in limitations in the ability to create and leverage audience segments, which are crucial for personalized and targeted digital marketing efforts.",
        Reference: ["https://mv-bim.com/eng/cookie-policy/"],
      },
    ],
  },
  li_sugr: {
  ...
  s_vi_x7Cmgx7Ebx23jkxxx23zkx7Dz: {
    ".2o7.net": [
      {
        Category: "User Engagement and Analytics",
        Purpose:
          "These cookies are used to count visits and traffic sources to measure and improve the performance of the site. They help to know which pages are the most and least popular and see how visitors move around the site. All information these cookies collect is aggregated and therefore anonymous.",
        Impact:
          "Prevent knowing when a user has visited the site, and will not be able to monitor its performance.",
        Reference: [
          "https://www.rybelsus.info/data-privacy-and-user-rights/cookie-list.html",
        ],
      },
    ],
  },
