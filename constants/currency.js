const CURRENCY = [
  ...
  { value: "ANG", label: "Antillean Guilder (ANG)" },
  ...
  { value: "STN", label: "São Tomé and Principe Dobra (STN)" },
  ...
  { value: "TWD", label: "Taiwanese Dollar (TWD)" },
  ...
  { value: "XAF", label: "Central African Franc (XAF)" },
  { value: "XCD", label: "East Caribbean Dollar (XCD)" },
  { value: "XDR", label: "Special Drawing Rights (XDR)" },
  { value: "XOF", label: "West African Franc (XOF)" },
  { value: "XPF", label: "Pacific Franc (XPF)" },
